...
const addOne = (arr) => {
  let myArr = [];
  arr.forEach(num => myArr.push(num + 1));
  return myArr;
};
...
const addExclamation = (arr) => {
  let myArr = [];
  arr.forEach(string => myArr.push(string + '!'));
  return myArr;
};
...
const allUpperCase = (arr) => {
  let myArr = [];
  arr.forEach(string => myArr.push(string.toUpperCase()));
  return myArr;
};
...
const speaker = (words, callback) => {
  let myArr = [];
  words.forEach(string => myArr.push(callback(string)));
  return myArr;
};
